...
function Cloudy({ width, height }) {
    return (
        <motion.svg variants={animation} animate='upDown' className='mt-3' xmlns="http://www.w3.org/2000/svg" width={width} height={height}
        ...
        >
            ...
            <g id="Layer_x0020_1">
                ...
                <rect fill={'none'} width="2048" height="2048" rx="256.001" ry="256.001" />
                <path fill={'#FFFFFE'}
